...
let G_HotKeyDict: any = {
	...
	NNN: {
		все: {
			...
			"ctrl_l+]":
				"Свернуть(в оболочку пользователя) nnn для выполнения команды(откроет путь который сейчас в nnn)(для выхода нажмите ctrl_l+d)",
			q: "выйти из nnn",
			...
			"shift_l+b":
				"Сделать из текущего место избранным(оно будет доступно из любого места по команде b)",
	...
	vs_code_r: {
		"Редактор кода": {
			...
			"ctrl_l+win+right":
				"Вернутся в бедующее место редактирования (`Go Forward`)",
			// "Поиск в коде"
			"ctrl_l+R":
