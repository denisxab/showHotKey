...
let G_HotKeyDict: any = {
	...
	vs_code_r: {
		"Редактор кода": {
			...
			"ctrl_l+shift_L+1":
				"Показать / Скрыть правую панель (`workbench.action.toggleSidebarVisibility`)",
			// Терминал
			"ctrl_l+`":
				"Открыть окно терминала (`workbench.action.terminal.toggleTerminal`)",
			"ctrl_l+shift_L+`":
				"Создать новый терминал (`workbench.action.terminal.new`)",
			"ctrl_l+shift_L+C":
				"Открыть стандартный внешний терминал (`workbench.action.terminal.openNativeConsole`)",
			// Вкладки
			"Alt_L + 1":
				"Перейти во вкладку по номеру (`workbench.action.openEditorAtIndex1`)",
			"Alt_L + 2":
				"Перейти во вкладку по номеру (`workbench.action.openEditorAtIndex1`)",
			"Alt_L + 3":
				"Перейти во вкладку по номеру (`workbench.action.openEditorAtIndex1`)",
			...
			"Alt_L + 9":
				"Перейти во вкладку по номеру (`workbench.action.openEditorAtIndex1`)",
			"ctrl_l+tab":
				"Переключиться на следующие вкладку (`workbench.action.quickOpenPreviousRecentlyUsedEditorInGroup`)",
			"ctrl_l+shift_L+tab":
				"Переключиться на предыдущее вкладку (`workbench.action.quickOpenLeastRecentlyUsedEditorInGroup`)",
			// Окна
			"ctrl_l + 1":
				"Переключиться в окно по номеру (`workbench.action.focusFirstEditorGroup`)",
			"ctrl_l + 2":
				"Переключиться в окно по номеру (`workbench.action.focusFirstEditorGroup`)",
			"ctrl_l + 3":
				"Переключиться в окно по номеру (`workbench.action.focusFirstEditorGroup`)",
			...
			"ctrl_l + 5":
				"Переключиться в окно по номеру (`workbench.action.focusFirstEditorGroup`)",
			"ctrl_l+\\":
				"Разделить текущие окно на два (`workbench.action.splitEditor`)",
			...
			"ctrl_l+shift_L+P":
				"Палитра всех команд (`workbench.action.showCommands`)",
			"ctrl_l + K + M":
				"Выбрать язык файла (`workbench.action.editor.changeLanguageMode`) ",
			// Редактирование кода
			"ctrl_l+/": "Закомментировать или раскомментировать строку",
			F2: "Переименовать переменную (`editor.action.rename`)",

			"ctrl_l+enter":
				"Вставить перенос ниже  (`editor.action.insertLineAfter`)",
			"ctrl_l+shift_L+enter":
			...
			"shift_L+Alt_L++right":
				"Увеличить выделенное рядом (`editor.action.smartSelect.expand`)",
			"shift_L+Alt_L+left":
				"Уменьшить выделанною рядом (`editor.action.smartSelect.shrink`) ",
			...
			"ctrl_l+shift_L+R":
				"Найти с заменой во всех файлах проекта (`workbench.action.replaceInFiles`)",
			"ctrl_l+shift_L+l":
				"Выделить все вхождения выделенного текста (`editor.action.selectHighlights`+`selectAllSearchEditorMatches`)",
			"Alt_L+Enter":
				"Выделить все вхождения из поиска (`search.action.openInEditor`)",
			F3: "Прейти к следующему результату поиска (`editor.action.nextMatchFindAction`)",
			"shift_L+f3":
				" Перейти к предыдущему результату поиска (`editor.action.previousSelectionMatchFindAction`)",
			...
			"ctrl_l+T":
				"Поиск(ленивый) по переменным в коде (`workbench.action.showAllSymbols`)",
			"ctrl_l+shift_L+O":
